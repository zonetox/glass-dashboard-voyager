            ...
            {activeSection === 'settings' && (
              <div className="space-y-6">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground">Cấu hình tài khoản và tính năng bảo mật</p>
                </div>
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Nhận thông báo về kết quả phân tích</p>
                        </div>
                      </div>
                      <Button variant="outline" size="sm">
                        Bật
